...
VALUES ('staging-subscription', 'staging-org', 'FREE', 'ACTIVE', 'MOCK', CURRENT_TIMESTAMP);
...
INSERT INTO "OrgMembership" ("id", "organizationId", "userId", "roleId", "isOwner") VALUES
  ('staging-om-admin', 'staging-org', 'staging-admin', 'staging-role-admin', true),
  ('staging-om-member', 'staging-org', 'staging-member', 'staging-role-member', false);
