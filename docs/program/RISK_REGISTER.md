...
| R-020 | Email real P5 aún no fue promovido a producción | Alta | Media | Circuito end-to-end verde en aislamiento; mantener registro cerrado hasta promoción y smoke productivo | Product/Security | Cerrado localmente; promoción bloqueada |
