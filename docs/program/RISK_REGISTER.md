...
| R-020 | Gmail aún no tiene refresh token autorizado y el worker no entrega emails reales | Alta | Alta | Outbox transaccional y provider listos; mantener registro cerrado hasta consentimiento, smoke real y promoción | Product/Security | Mitigado localmente; activación bloqueada |
