...
| R-023 | Adapter Mercado Pago implementado pero webhook/suscripción aún no se validaron end-to-end con comprador sandbox | Alta | Media | Crear comprador de prueba separado, staging HTTPS, secreto HMAC y smoke reversible antes de producción | Titular + Billing | Mitigado localmente; sandbox externo pendiente |
